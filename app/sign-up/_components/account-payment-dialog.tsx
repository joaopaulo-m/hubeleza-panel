...
export const AccountPaymentDialog = (props: AccountPaymentDialogProps) => {
            ...
            <div className="space-y-6">
              <DialogHeader className="text-center pb-2">
                <DialogTitle className="text-2xl font-bold text-gray-900">
                  Finalize seu cadastro com um Pix
                </DialogTitle>
                <DialogDescription>
                  Assim que o pagamento for identificado, sua conta será ativada automaticamente — e você ainda recebe <b>R$300 em créditos bônus</b>.
                </DialogDescription>
                <div className="mt-2">
                  <p className="text-3xl font-bold text-purple-600">{transaction ? formatCurrency(transaction.amount) : formatCurrency(0)}</p>
