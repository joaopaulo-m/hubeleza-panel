...
export function AffiliateTransactionsFilter() {
  ...
  const hasFilters = type || startDate || endDate || partnerNameQuery;
  const activeFiltersCount = [type, startDate, endDate, partnerNameQuery].filter(Boolean).length;
