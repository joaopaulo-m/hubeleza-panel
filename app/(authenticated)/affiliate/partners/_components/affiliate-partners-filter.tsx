...
export function AffiliatePartnersFilter() {
  ...
  const hasFilters = startDate || endDate || nameQuery;
  const activeFiltersCount = [startDate, endDate, nameQuery].filter(Boolean).length;
