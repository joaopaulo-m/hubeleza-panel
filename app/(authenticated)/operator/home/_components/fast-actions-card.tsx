...
export const OperatorFastActionsCard = () => {
  return (
    <Card className="w-full gap-2 border-0 shadow-sm hover:shadow-md transition-all duration-300">
      ...
      <CardContent className="space-y-3">
        ...
        <Link href="/invites" className="w-full flex p-3 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors text-left group cursor-pointer">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium text-slate-900">Ver convites</div>
              <div className="text-xs text-slate-500">Conferir seus convites</div>
            </div>
          </div>
        </Link>
